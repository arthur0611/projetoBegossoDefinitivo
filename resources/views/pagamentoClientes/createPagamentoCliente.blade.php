...
<!-- formulario -->
<div class="container">
<h1><center>Cadastrar Pagamento Cliente</center></h1>
        <div class="row">
            <div class="col-sm-12">
    <form action="{{ route('salvar_pagamentoCliente') }}" method="post">
        @csrf
        <div>
            <label for="tipojogo_id"  class="form-label">Venda</label>
            <input type="number" class="form-control" name="Vendas_id" id="Vendas_id" required> 
        </div>
        <div>
