...
<div class="container">
    ...
    <form action="{{ route('atualizar_fornecedor', ['id' => $fornecedor->id]) }}" method="post">
        ...
        <div>
            ...
            <input type="text" class="form-control" name="nomeFantasia" id="nomeFantasia" value = "{{$fornecedor->nomeFantasia}}"> 
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" class="form-control" name="contato" id="contato" value = "{{$fornecedor->contato}}"> 
        </div>
        <div>
        ...
        <div>
            ...
            <input type="text" class="form-control" name="site" id="site" value = "{{$fornecedor->site}}"> 
        </div>
