...
<!-- lista -->
    <div class="container">
    <h1><center>Listar Tipo Plataforma</center></h1>
        <div class="row">
            <div class="col-sm-12">
    <table class="table table-striped">
        ...
        @foreach($tipoPlataformas as $tipoPlataforma)
        <tr>
            <td>{{$tipoPlataforma->descricao}}</td>
             <td><a href="{{ route('editar_tipoPlataforma',['id' => $tipoPlataforma->id] )}}"> Editar</a></td>
            <td><a href="{{ route('excluir_tipoPlataforma',['id' => $tipoPlataforma->id] )}}" >Excluir</a></td> 
        </tr>    
        @endforeach
    </table>
